    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Tribe Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Tribe Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Tribe Core is shutting down...") + "<br /><br />" +
