    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Tribe Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tribe address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Tribe Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tribe Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tribe"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tribe addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tribe addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Tribe Core help message to get a list with possible Tribe command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Tribe Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tribe network", "", count));
}
...
{
    QString strTitle = tr("Tribe Core"); // default title
